...
module.exports = function (opts) {
  ...
  return {
    ...
    actionExecutions: endpoint('/executions', Opts, Readable, Writable, Enumerable),
    history: endpoint('/history/liveactions', Opts, Readable, Paginatable, Watchable),
    historyFilters: endpoint('/executions/views/filters', Opts, Enumerable),
